...
public class Two_Activity extends FragmentActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        twoAdView = (AdView) findViewById(R.id.adView);

        pager = (ViewPager) findViewById(R.id.pager);
        pagerAdapter = new Two_Activity.MyFragmentPagerAdapter(getSupportFragmentManager());
    ...
    public class MyFragmentPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            return PageFragment_two.newInstance(position);
        }
