...
public class One_Activity extends FragmentActivity implements View.OnClickListener {
    private BannerHelper mBannerHelper;
    Button backToStartB;
    ViewPager pager;
    PagerAdapter pagerAdapter;
    int currentPage = 0;
    static int PAGE_COUNT = 44;
    AdView oneAdView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        oneAdView = (AdView) findViewById(R.id.adView);
