...
public class Five_Activity extends FragmentActivity implements View.OnClickListener {
    private BannerHelper mBannerHelper;
    Button backToStartB;
    ViewPager pager;
    PagerAdapter pagerAdapter;
    int currentPage = 0;
    static int PAGE_COUNT = 11;
    AdView fiveAdView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fiveAdView = (AdView) findViewById(R.id.adView);

        pager = (ViewPager) findViewById(R.id.pager);
        pagerAdapter = new Five_Activity.MyFragmentPagerAdapter(getSupportFragmentManager());
    ...
    public class MyFragmentPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            return PageFragment_five.newInstance(position);
        }
