...
public class Six_Activity extends FragmentActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sixAdView = (AdView) findViewById(R.id.adView);

        pager = (ViewPager) findViewById(R.id.pager);
        pagerAdapter = new Six_Activity.MyFragmentPagerAdapter(getSupportFragmentManager());
    ...
    public class MyFragmentPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            return PageFragment_six.newInstance(position);
        }
